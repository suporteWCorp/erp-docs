...
2. Clique em **Solicitação de Pagamento**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Solicitação de Pagamento**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Financeiro > Solicitação de Pagamento**, colete:
