...
2. Clique em **Relatório de Ocorrência**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Relatório de Ocorrência**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Relatórios > Relatório de Ocorrência**, colete:
