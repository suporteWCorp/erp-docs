...
Acessar e gerar relatórios gerais do ERP.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Relatórios**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Relatórios > Relatórios**, colete:
