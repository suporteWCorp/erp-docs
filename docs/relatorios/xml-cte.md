...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **XML(s) CTe**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Relatórios > XML(s) CTe**, colete:
