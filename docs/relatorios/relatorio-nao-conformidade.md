...
2. Clique em **Relatório de Não Conformidade**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Relatório de Não Conformidade**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Relatórios > Relatório de Não Conformidade**, colete:
