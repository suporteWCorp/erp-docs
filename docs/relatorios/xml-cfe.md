...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **XML(s) CFe**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Relatórios > XML(s) CFe**, colete:
