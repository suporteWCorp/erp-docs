...
2. Clique em **Relatório WhatsApp**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Relatório WhatsApp**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Relatórios > Relatório WhatsApp**, colete:
