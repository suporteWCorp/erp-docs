...
2. Clique em **Faturamento de Recorrência**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Faturamento de Recorrência**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Serviços > Faturamento de Recorrência**, colete:
