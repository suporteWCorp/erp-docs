...
2. Clique em **Cadastro de Serviço**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Cadastro de Serviço**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Serviços > Cadastro de Serviço**, colete:
