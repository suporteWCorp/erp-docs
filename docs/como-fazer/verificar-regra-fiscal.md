---
id: verificar-regra-fiscal
title: Como verificar regra fiscal
type: guia
category: Faturamento
description: Aprenda como verificar a regra fiscal utilizada no processo de faturamento.
status: published
tags:
  - regra fiscal
...
- Natureza de Operação ou documento fiscal a conferir
...
## Verificar pela Administração

[Demonstração da verificação pela Administração](../assets/videos/guias/verificar-regra-fiscal/ver-regra-fiscal-administracao.mp4){ .wc-video-link }
