...
Use esta rotina quando houver necessidade de executar ou consultar processos relacionados a **Grupo de Processo**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Grupo de Processo**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Produção > Grupo de Processo**, colete:
