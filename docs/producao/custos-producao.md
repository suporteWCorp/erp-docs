...
2. Clique em **Custos de Produção**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Custos de Produção**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Produção > Custos de Produção**, colete:
