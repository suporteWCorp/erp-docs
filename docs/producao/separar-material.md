...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Separar Material**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Produção > Separar Material**, colete:
