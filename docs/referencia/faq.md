...
Encontre respostas rápidas para as dúvidas mais frequentes sobre o WCorp.
{ .wc-listing-intro }

## Perguntas frequentes

<div class="wc-faq-list" markdown>

<details class="wc-faq-item" markdown>
<summary>Tem como cancelar CT-e depois de 7 dias?</summary>
...
É possível cancelar um CT-e após o prazo padrão de 7 dias por meio do cancelamento extemporâneo, dependendo de autorização da SEFAZ do estado.

[Ver resposta completa →](faq/cancelar-cte-apos-prazo.md){ .wc-faq-link }

</details>

<details class="wc-faq-item" markdown>
<summary>Tem como cancelar NF-e depois de 30 dias?</summary>

<p class="wc-faq-answer"><span class="wc-faq-answer__label">Resposta:</span> <strong class="wc-faq-answer__value wc-faq-answer__value--yes">Sim</strong></p>

É possível cancelar uma NF-e após 30 dias por meio do cancelamento extemporâneo, dependendo de autorização da SEFAZ do estado.

[Ver resposta completa →](faq/cancelar-nfe-apos-prazo.md){ .wc-faq-link }

</details>

<details class="wc-faq-item" markdown>
<summary>Tem como deixar um percentual de comissão definido para o cliente?</summary>

<p class="wc-faq-answer"><span class="wc-faq-answer__label">Resposta:</span> <strong class="wc-faq-answer__value wc-faq-answer__value--yes">Sim</strong></p>

O percentual pode ser definido no cadastro do cliente, na aba **Comissões**, adicionando a comissão e salvando o cadastro.

[Ver resposta completa →](faq/comissao-cliente.md){ .wc-faq-link }

</details>

<details class="wc-faq-item" markdown>
<summary>Consigo bloquear a venda se o cliente tiver pagamentos em atraso?</summary>

<p class="wc-faq-answer"><span class="wc-faq-answer__label">Resposta:</span> <strong class="wc-faq-answer__value wc-faq-answer__value--yes">Sim</strong></p>

O bloqueio pode ser configurado no cadastro do cliente, na aba **Comercial**, usando a opção de bloquear vendas caso existam pagamentos em atraso.

[Ver resposta completa →](faq/bloquear-venda-cliente-inadimplente.md){ .wc-faq-link }
...
[Consultar o Manual de Usuários](../administracao/usuarios.md){: target="_blank" rel="noopener" .wc-faq-link }

</details>

<details class="wc-faq-item" markdown>
<summary>Como descobrir minha versão do WCorp?</summary>

<p class="wc-faq-answer"><span class="wc-faq-answer__label">Resposta rápida</span></p>

Consulte a identificação de versão exibida no WCorp. Caso ela não esteja visível, informe à equipe de Suporte a empresa, o usuário e a tela acessada.
