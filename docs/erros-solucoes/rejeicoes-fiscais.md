...
<div class="wc-solution-list" data-wc-solution-list markdown>

<label class="wc-solution-filter">
  <span>Buscar rejeição</span>
  <input type="search" data-wc-solution-filter placeholder="Ex.: 656, consumo indevido ou cole a mensagem retornada..." autocomplete="off">
</label>

<div class="wc-solution-categories" data-wc-solution-categories>
  ...
  <div id="rejeicoes-nfe" class="wc-solution-category__panel">
    <div class="wc-solution-category__content">
      <div class="wc-rejection-list">
        ...
        <a class="wc-rejection-item" href="rejeicao-233-ie-destinatario-nao-cadastrada/" data-search="233 rejeição ie destinatário não cadastrada inscrição estadual cliente comercial nfe indicador ie">
          <span class="wc-rejection-item__code">233</span>
          <span class="wc-rejection-item__title">IE do destinatário não cadastrada</span>
          <span class="wc-rejection-item__document">NF-e</span>
          <span class="wc-rejection-item__arrow" aria-hidden="true">›</span>
        </a>
        <a class="wc-rejection-item" href="rejeicao-280-certificado-digital-invalido/" data-search="280 rejeição certificado digital inválido vencido revogado incompatível emissor empresa nf-e nfe">
          <span class="wc-rejection-item__code">280</span>
          <span class="wc-rejection-item__title">Certificado Digital inválido</span>
          <span class="wc-rejection-item__document">NF-e</span>
          <span class="wc-rejection-item__arrow" aria-hidden="true">›</span>
        </a>
        ...
        <a class="wc-rejection-item" href="rejeicao-537-total-desconto/" data-search="537 rejeição total desconto difere somatório itens impostos materiais nf-e nfe">
          <span class="wc-rejection-item__code">537</span>
          <span class="wc-rejection-item__title">Total do Desconto difere do somatório dos itens</span>
          <span class="wc-rejection-item__document">NF-e</span>
          <span class="wc-rejection-item__arrow" aria-hidden="true">›</span>
        </a>
        <a class="wc-rejection-item" href="rejeicao-538-total-ipi/" data-search="538 rejeição total ipi difere somatório itens impostos materiais nf-e nfe">
          <span class="wc-rejection-item__code">538</span>
          <span class="wc-rejection-item__title">Total do IPI difere do somatório dos itens</span>
          <span class="wc-rejection-item__document">NF-e</span>
          <span class="wc-rejection-item__arrow" aria-hidden="true">›</span>
        </a>
        ...
        <a class="wc-rejection-item" href="rejeicao-cancelamento-690-nfe-com-cte-mdfe/" data-search="690 rejeição cancelamento pedido cancelamento nf-e com ct-e ou mdf-e cte mdfe sefaz">
          <span class="wc-rejection-item__code">690</span>
          <span class="wc-rejection-item__title">Pedido de cancelamento para NF-e com CT-e ou MDF-e</span>
...
<div class="wc-solution-results" data-wc-solution-results hidden>
  <h2>Resultados encontrados</h2>
  <div class="wc-rejection-list" data-wc-solution-result-list></div>
</div>

<p class="wc-solution-empty" data-wc-solution-empty hidden>Nenhuma rejeição encontrada para o filtro informado.</p>
