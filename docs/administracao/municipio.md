...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Município**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Administração > Município**, colete:
