...
2. Clique em **Layout de Ficha Técnica**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Layout de Ficha Técnica**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Administração > Layout de Ficha Técnica**, colete:
