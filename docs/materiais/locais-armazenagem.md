...
2. Clique em **Locais de Armazenagem**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Locais de Armazenagem**. |
...
??? info "Ver mais para Suporte"
    ...
    A rotina deve registrar, consultar ou concluir o processo de materiais com status claro para o usuário.

    ## Orientação para Suporte

    Ao atender problemas em **Materiais > Locais de Armazenagem**, colete:
