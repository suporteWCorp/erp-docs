...
2. Clique em **Conversão de Unidades**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Conversão de Unidades**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Materiais > Conversão de Unidades**, colete:
