...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Etiqueta**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Materiais > Etiqueta**, colete:
