...
Use esta rotina quando houver necessidade de executar ou consultar processos relacionados a **Contratos**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Contratos**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Contratos > Contratos**, colete:
