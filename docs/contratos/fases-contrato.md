...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Fases do Contrato**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Contratos > Fases do Contrato**, colete:
