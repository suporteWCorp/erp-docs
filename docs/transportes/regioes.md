...
Use esta rotina quando houver necessidade de executar ou consultar processos relacionados a **Regiões**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Regiões**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Transportes > Regiões**, colete:
