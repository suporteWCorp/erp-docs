...
2. Clique em **Manifesto de Transporte**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Manifesto de Transporte**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Transportes > Manifesto de Transporte**, colete:
