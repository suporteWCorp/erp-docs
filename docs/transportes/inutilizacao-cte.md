...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Inutilização CTe**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Transportes > Inutilização CTe**, colete:
