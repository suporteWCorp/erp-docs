...
Use esta rotina quando houver necessidade de executar ou consultar processos relacionados a **Carga**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Carga**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Transportes > Carga**, colete:
