# Requisições x Projeção de Vendas
...
2. Clique em **Requisições x Projeção de Vendas**.
...
| Dúvida | Orientação |
| --- | --- |
| Quando devo usar esta rotina? | Use quando o processo estiver relacionado a **Requisições x Projeção de Vendas**. |
...
??? info "Ver mais para Suporte"
    ...
    Ao atender problemas em **Compras > Requisições x Projeção de Vendas**, colete:
